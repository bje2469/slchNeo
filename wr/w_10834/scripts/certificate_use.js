...
certificateUse1 = {
	...
	doUpdate: function() 
	{
		...
		if (nameVar != undefined) {
			...
			elem.innerHTML += "<div class='items' tabindex="+(tabindex+2)+">" + nameVar + "</div>";			
		}
		
		//setup custom
		if (customVar != undefined) {
			elem = document.getElementById('custom');
			elem.innerHTML += "<div class='items'  tabindex="+(tabindex+6)+">" + customVar + "</div>";			
		}		
		//setup months
		...
		elem.innerHTML += "<div class='items'  tabindex="+(tabindex+4)+">" + generalStyles.sig + "</div>";			
